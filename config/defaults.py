...
_C.TRAIN.DATASET = "CAMUS_displacement_cv_1"


# we split this into two parameters to avoid type errors
_C.TRAIN.NUM_KPTS = 107

_C.TRAIN.NUM_KPTS_MULTISTRUCTURE = [ 43,21,43 ]
...
_C.TRAIN.LOAD_OPTIMIZER = False

_C.TRAIN.SAVE_INTERVAL = None
...
_C.MODEL.NAME = "GCN_multi_displacement_small"

# Model backbone [resnet50, mobilenet2, r3d_18]
_C.MODEL.BACKBONE = "mobilenet2"

# Loss function [L2, WeightedCrossEnt, CrossEnt, L2Seq]
_C.MODEL.LOSS_FUNC = ["L2_distances"]

# For finetuning pretrained model, the path to the model name is specified here, otherwise None
...
# Input size at training
_C.EVAL.INPUT_SIZE = 256
# weight file for the model, must be specified to evaluate a trained model
_C.EVAL.WEIGHTS = 'experiments/logs/CAMUS_displacement_cv_1/GCN_multi_displacement_small/mobilenet2/trained/weights_CAMUS_displacement_cv_1_GCN_multi_displacement_small_best_loss.pth'
...
def default_argument_parser(epilog=None):
    ...
    parser.add_argument(
        ...
        default="files/configs/Train_displacement_CAMUS.yaml",
        type=str,
    )
    parser.add_argument(
        "opts",
