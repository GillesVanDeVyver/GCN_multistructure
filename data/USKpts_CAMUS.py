...
########################################################################
########################################################################
class USKpts_CAMUS(data.Dataset):
    ...
    def get_img_and_kpts(self, index: int):
        ...
        if len(data)==5:
            img, kpts_LV,kpts_LA, kpts_EP, filepath_frame = data
        else:
            img, kpts_LV,kpts_LA, kpts_EP,seg, filepath_frame = data
        #kpts = kpts_LV
        kpts = None
    ...
    def __getitem__(self, index):
        ...
        return img_rgb, kpts, data["img_path"]
